class RentalOrder < ApplicationRecord
  ...
  def self.latestparking(rentalid)
    ...
    if rent.nil?
      rent = {rental_order: {id: "0",ParkingAddress: {id: "0",address: "0",city: "0",state: "0",country: "0",zipcode: "0",additionalDetails: "0",montlyRate: "0",weeklyRate: "0",dailyRate: "0",hourlyRate: "0",xCoordinate: "0",yCoordinate: "0",approval: "0",user: {id: "0",email: "0",firstName: "0",lastName: "0",gender: "0",age: "0",identificationCardNumber: "0"}},user: {id: "0",email: "0",firstName: "0",lastName: "0",gender: "0",age: "0",identificationCardNumber: "0"},rentStart: "0",rentEnd: "0",orderTotal: "0",orderStatus: "0"}}
      return rent.to_json
    else
      return rent
    end
